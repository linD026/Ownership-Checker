...
static void print_plugin_info(struct plugin_name_args *plugin_info,
...
int plugin_init(struct plugin_name_args *plugin_info,
                struct plugin_gcc_version *version)
{
    // We check the current gcc loading this plugin against
    // the gcc we used to created this plugin
    ...
    print_plugin_info(plugin_info, version);
